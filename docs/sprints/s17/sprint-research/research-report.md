...
- [INT-0016 — Showcase README with the Mekzantine brand](../../intents/INT-0016-showcase-readme.md)
  — **created** this sprint (`proposed`). A presentation/brand outcome (a beautified README), distinct from the reader/shell feature intents.
...
(GitHub can't use web fonts). Delivers INT-0016's four criteria. A pause before the full
Tauri port.
