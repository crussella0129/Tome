...
evidence for criterion 2; the banner (T-040) is verified by its artifact. All
captures + the banner + the rendered README are **surfaced to the user** for the
visual sign-off (criteria 1–3 are a user judgment, not self-certified).
